            ...
            <div class="box">
                ...
                try {
                    ...
                    echo "</div>";
                        ...
                        echo "<p class='text-center'>Gejala yang anda masukkan belum bisa terdeteksi pada sistem kami.</p>";
                        echo "<p class='text-center'>Silakan chat dengan dokter untuk konsultasi lebih lanjut.</p>";
                        echo "<a href='../index.php?p=select_chat' class='btn btn-primary'>Chat Dokter</a>";
